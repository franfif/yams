...
class Game {
  constructor(n) {
    ...
    this.combinations.push("Ones", "Twos", "Threes", "Fours", "Fives", "Sixes");
    this.combinations.push("Total", "Bonus", "Three of a kind", "Four of a kind");
    this.combinations.push("Full House", "Small Straight", "Large Straight", "Chance");
    this.combinations.push("Yam", "Total", "Grand Total");
  ...
  generateTable() {
    for (let element of this.combinations) {
